...
SELECT SUBSTRING(NULL, 1, 2) AS result;
SELECT SUBSTRING("hello", NULL, 2) AS result;
SELECT SUBSTRING("hello", 1, NULL) AS result;

-- SUBSTR tests (alias)
SELECT SUBSTR("hello", 2, 3) AS result;
...
SELECT NULLIF(1, NULL) AS result;
...
SELECT IF(5>3, 100, 200) AS result;
SELECT IF(2<1, 100, 200) AS result;
...
SELECT DATE_ADD(NULL, NULL) AS result;

SELECT DATE_ADD(NOW(), INTERVAL 1 DAY) AS ignore_seconds;
SELECT DATE_ADD(NOW(), INTERVAL 1 MONTH) AS ignore_seconds;
SELECT DATE_ADD(NOW(), INTERVAL 1 YEAR) AS ignore_seconds;
SELECT DATE_ADD(NOW(), INTERVAL 1 HOUR) AS ignore_seconds;
SELECT DATE_ADD(NOW(), INTERVAL 30 MINUTE) AS ignore_seconds;
SELECT DATE_ADD(NOW(), INTERVAL 45 SECOND) AS ignore_seconds;
SELECT DATE_ADD(NOW(), NULL) AS ignore_seconds;
...
SELECT TIMESTAMPDIFF(SECOND, "2024-01-15 10:00:00", "2024-01-15 10:00:45") AS result;
...
SELECT TIMESTAMPDIFF(DAY, "2024-01-15", NULL) AS result;
