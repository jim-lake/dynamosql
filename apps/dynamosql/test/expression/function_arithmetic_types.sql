...
SELECT 1.123456789 + 2.987654321 AS result;
SELECT 1.123456789 + "2" AS result;
...
SELECT 5.123456789 - 2.5 AS result;
SELECT 5.123456789 - 2.987654321 AS result;
SELECT 5.123456789 - "2" AS result;
...
SELECT 3.5 * 4.123456789 AS result;
SELECT 3.5 * "4" AS result;
...
SELECT 10 / 2.123456789 AS result;
SELECT 10 / "2" AS result;
...
SELECT 10.5 / 2.123456789 AS result;
SELECT 10.5 / "2" AS result;
...
SELECT 10.123456789 / 2.987654321 AS result;
SELECT 10.123456789 / "2" AS result;
